@echo off
REM GitHub 저장소 초기화 및 푸시 스크립트 (Windows)
...
echo.
echo 💾 첫 커밋 생성 중...
git commit -m "🎮 Initial commit: Crimson Desert Pre-Launch Tracker - Features: Multi-platform data tracking (Steam, YouTube, Reddit, Twitter), Automated daily collection with scheduler, Data visualization and reporting, SQLite database storage, GitHub Actions workflow"
